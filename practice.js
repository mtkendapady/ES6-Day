...
const vocab = [ "let", "const", "destructuring", "spread", "rest", "arrow function" ];
...
// multiplied by num.
function multiply( num, ...additional ) {
	return additional.map( int => int * num );
}
...
var mooresBits = bits.map( int => int * 2 );
